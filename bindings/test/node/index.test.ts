...
import { fr_add, FrWrapper, ElementWrapper, element_add } from '../../outputs/out/rust_verkle_wasm';
...
it('point addition smoke test', async () => {
    ...
    const expected = ElementWrapper.scalarMul(ElementWrapper.generator(), scalar).toHexString();
