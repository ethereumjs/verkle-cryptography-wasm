...
export function getTreeKeyJs(context: Context, address: Uint8Array, treeIndex: Uint8Array, subIndex: number): Uint8Array {
...
export function getTreeKeyHashJs(context: Context, address: Uint8Array, treeIndex: Uint8Array): Uint8Array {
