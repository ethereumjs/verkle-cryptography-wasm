...
import { pedersenHash } from '../banderwagon_bindings/index'
...
describe('pedersenHash', () => {
  test('computes the expected pedersenHash for the zero address', () => {
    ...
    const expectedHash = 'bf101a6e1c8e83c11bd203a582c7981b91097ec55cbd344ce09005c1f26d1922'
  ...
  test('computes the expected pedersenHash for a given address', () => {
    ...
    const expectedHash = '76a014d14e338c57342cda5187775c6b75e7f0ef292e81b176c7a5a700273700'
